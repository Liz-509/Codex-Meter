...
- [Windows 10/11 x64 安装包 — Codex Meter v1.4.1（当前 Windows 稳定版）](https://github.com/Liz-509/Codex-Meter/releases/download/v1.4.1/Codex-Meter-Windows-x64-v1.4.1.exe)
...
Codex Meter 没有分析统计或独立后端，不存储账户凭据，也不会上传本地会话内容。提示词预览、项目统计、额度快照和导出报告均只保留在本机。详见 [PRIVACY.md](PRIVACY.md)。
