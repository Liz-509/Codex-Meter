...
- [Windows 10/11 x64 — Codex Meter v1.3.2](https://github.com/Liz-509/Codex-Meter/releases/download/v1.3.2/Codex-Meter-Windows-x64-v1.3.2.zip)
...
The self-contained x64 app is written to `build\windows\win-x64`, and the portable archive is written to `outputs\Codex-Meter-Windows-x64-v1.3.2.zip`. Extract the archive and run `Codex Meter.exe`; installation and administrator access are not required.
